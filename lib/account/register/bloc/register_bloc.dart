...
import 'package:Cocoverde/account/register/bloc/register_models.dart';
...
class RegisterBloc extends Bloc<RegisterEvent, RegisterState> {
  ...
  Stream<RegisterState> onConfirmPasswordChange(ConfirmPasswordChanged event) async* {
    ...
    if(password == confirmPassword.value) {
      ...
      yield state.copyWith(
          confirmPassword: confirmPassword,
          //status: FormzSubmissionStatus.invalid, generalErrorKey: passwordNotIdenticalKey
      );
    }
  }
  ...
  Stream<RegisterState> onLoginChange(LoginChanged event) async* {
     final name = NameInput.dirty(event.login);
     yield state.copyWith(
      name: name,
