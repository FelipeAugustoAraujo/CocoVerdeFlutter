...
class RegisterScreen extends StatelessWidget {
  RegisterScreen() : super(key: CocoverdeKeys.registerScreen);
  ...
  //                  labelText:'Login',
  //                  errorText: state.login.isNotValid ? LoginValidationError.invalid.invalidMessage : null));
  //        });
  //  }
    ...
    return BlocBuilder<RegisterBloc, RegisterState>(
        ...
        builder: (context, state) {
          return TextFormField(
              ...
              decoration: InputDecoration(
                  labelText:'Password',
                  errorText: state.password.isNotValid ? PasswordValidationError.invalid.invalidMessage : null));
        });
  }
        ...
        builder: (context, state) {
          return TextFormField(
              ...
              decoration: InputDecoration(
                  ...
                  errorText: state.confirmPassword.isNotValid ? ConfirmPasswordValidationError.invalid.invalidMessage : null));
        });
  }
        ...
        builder: (context, state) {
          return Column(
            children: <Widget>[
              ...
              Visibility(
                visible: state.termsAndConditions.isPure && state.termsAndConditions.isNotValid,
                child: Padding(
  ...
  Widget validationZone() {
    return BlocBuilder<RegisterBloc, RegisterState>(
        ...
        builder: (context, state) {
          return Visibility(
              visible: state.status.isFailure || state.isNotValid && state.generalErrorKey != HttpUtils.generalNoErrorKey,
              child: Center(
                child: Text(
    ...
    return BlocBuilder<RegisterBloc, RegisterState>(
        ...
        builder: (context, state) {
          return ElevatedButton(
            ...
            onPressed: state.isValid ? () => context.read<RegisterBloc>().add(FormSubmitted()) : null,
          );
        });
  }
