...
class ValorBaseInput extends FormzInput<BigDecimal, ValorBaseValidationError> {
  const ValorBaseInput.pure() : super.pure('');
  const ValorBaseInput.dirty([BigDecimal value = '']) : super.dirty(value);

  @override
  ValorBaseValidationError? validator(BigDecimal value) {
    return null;
  }
}
